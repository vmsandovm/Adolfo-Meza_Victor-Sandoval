// Misma aritmetica que Booth_datapath, pero los registros se construyen
// instanciando PIPO_register en vez de describirlos con always_ff.
module Booth_datapath_PIPO #( parameter int DW = 5
)(
    input  logic              Clock,
    input  logic              Reset,
    input  logic              Load,
